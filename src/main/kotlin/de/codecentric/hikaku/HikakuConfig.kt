...
/**
 * Configuration for [Hikaku] class. It let's you partially control the matching process.
 ...
 * @param reporter All [MatchResult]s will be passed to a reporter before the assertion takes place. Default is a [CommandLineReporter] that prints the results to stdout.
 */
